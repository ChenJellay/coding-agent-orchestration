...
from phase3.intent_compiler import compile_macro_intent_to_dag
from phase3.orchestrator import execute_dag


def main() -> None:
    parser = argparse.ArgumentParser(
        description="Phase 3 DAG orchestrator demo CLI",
    )
    parser.add_argument(
        "macro_intent",
        type=str,
